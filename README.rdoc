...
* Administrator: Vollzugriff auf die ganze Datenbank. Wird nur in Ausnahmefällen
  verwendet
* Postmaster: Lesezugriff auf alle Personen, mit Ausnahme von Personen mit der
  Rolle "externes Mitglied" in der Ebene Verein.
  
===== Rollen der Gruppenart Verein
* Administrator: Vollzugriff auf Personen, denen eine Rolle im Verein oder in
  einem Team des Vereins zugeordnet ist.
* Postmaster: Lesezugriff auf Personen, denen eine Rolle im Verein oder in einem
  Team des Vereins zugeordnet ist.
* Mitglied: Lesezugriff auf Personen, denen eine Rolle Verein zugeordnet ist
  (aber nicht auf Personen in Teams des Vereins).
  
===== Rollen der Gruppenart Team
* Administrator: Vollzugriff auf Personen, denen eine Rolle im Team oder in 
  einem Team des Teams zugeordnet ist.
* Postmaster: Lesezugriff auf Personen, denen eine Rolle im Team oder in einem
  Team des Teams zugeordnet ist.
* Mitglied: Lesezugriff auf Personen, denen eine Rolle im Team zugeordnet ist
  (aber nicht auf Personen in Teams des Teams).
* externes Mitglied: gleiche Rechte wie Team-Mitglied, aber nicht sichtbar für
  den Postmaster des Verbands.
